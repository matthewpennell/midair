...
namespace Midair\Medium\Database\Migrations;

use CodeIgniter\Database\Migration;

class CreateMedium extends Migration
{
    /**
     * Create a table to hold mediums pulled from an RSS feed.
    ...
    public function up()
    {
        ...
        $this->forge->createTable('mediums');
    }

    public function down()
    {
        $this->forge->dropTable('mediums');
    }
}
