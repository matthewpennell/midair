    ...
    <div class="content h-entry">
        ...
        <header class="title">
            ...
            <div class="source medium">
                <svg aria-hidden="true" width="24" height="24" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="u-syndication" href="<?= $data->link ?>" target="_blank">This story was first published on <strong>Medium</strong>. Visit the original here →</a>
            </div>
        </header>
        <article>
