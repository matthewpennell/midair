<article class="medium">
    <div class="meta">
        <svg aria-hidden="true" width="20" height="20" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span aria-hidden="true">&bull;</span>
        <a href="<?= $data->source ?>" class="external" target="_blank" aria-label="Open original Medium.com article in new tab"><span class="material-symbols-outlined">open_in_new</span></a>
    </div>
    <h2>
    ...
    <p><?= $data->excerpt ?></p>
    <p class="read-more"><a href="<?= $data->source ?>" target="_blank">Read full article on Medium.com</a></p>
</article>
