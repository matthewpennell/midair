...
namespace Midair\Strava\Database\Migrations;

use CodeIgniter\Database\Migration;

class CreateStrava extends Migration
{
    /**
     * Create a table to hold stravas pulled from an RSS feed.
    ...
    public function up()
    {
        ...
        $this->forge->createTable('strava');
    }

    public function down()
    {
        $this->forge->dropTable('strava');
    }
}
