    ...
    <div class="content h-review">
        ...
        <article>
            <div class="hexagon content__date">
                <time class="hexagon__inner dt-reviewed" datetime="<?= date('c', strtotime($data->pubDate)) ?>">
                    <span class="icon">
            ...
            <div class="content__body">
                <h2>Rating</h2>
                <p class="p-rating"><data value="<?= $data->rating ?>"><?= $data->rating ?></data></p>
                <?php if (strlen($data->review) > 1): ?>
                    <h2>Review</h2>
                    <p class="e-description"><?= $data->review ?></p>
                <?php endif; ?>
                <h2>Release year</h2>
