...
namespace Midair\Letterboxd\Database\Migrations;

use CodeIgniter\Database\Migration;

class CreateLetterboxd extends Migration
{
    /**
     * Create a table to hold letterboxds pulled from an RSS feed.
    ...
    public function up()
    {
        ...
        $this->forge->createTable('letterboxd');
    }

    public function down()
    {
        $this->forge->dropTable('letterboxd');
    }
}
