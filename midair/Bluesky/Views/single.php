...
<?= $this->section('content') ?>
    <article class="bluesky h-entry">
        ...
        <div class="meta">
            ...
            <time class="dt-published" datetime="<?= $data->pubDate ?>"><?= date('jS M Y', strtotime($data->pubDate)) ?></time>
            <span aria-hidden="true">&bull;</span>
            <a href="<?= $data->link ?>" class="external" target="_blank" aria-label="Open the original Bluesky post in a new tab"><span class="material-symbols-outlined">open_in_new</span></a>
        </div>
        <p class="e-content"><?= str_replace("\n", "<br />", $data->description) ?></p>
    </article>
