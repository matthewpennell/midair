...
namespace Midair\Bluesky\Database\Migrations;

use CodeIgniter\Database\Migration;

class CreateBluesky extends Migration
{
    /**
     * Create a table to hold blueskys pulled from an RSS feed.
    ...
    public function up()
    {
        ...
        $this->forge->createTable('blueskys');
    }

    public function down()
    {
        $this->forge->dropTable('blueskys');
    }
}
