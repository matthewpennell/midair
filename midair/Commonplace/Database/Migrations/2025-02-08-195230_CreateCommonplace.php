...
namespace Midair\Commonplace\Database\Migrations;

use CodeIgniter\Database\Migration;

class CreateCommonplace extends Migration
{
    /**
     * Create a table to hold commonplaces pulled from an RSS feed.
    ...
    public function up()
    {
        ...
        $this->forge->createTable('commonplace');
    }

    public function down()
    {
        $this->forge->dropTable('commonplace');
    }
}
