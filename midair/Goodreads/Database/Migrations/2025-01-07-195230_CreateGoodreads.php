...
namespace Midair\Goodreads\Database\Migrations;

use CodeIgniter\Database\Migration;

class CreateGoodreads extends Migration
{
    /**
     * Create a table to hold goodreadss pulled from an RSS feed.
    ...
    public function up()
    {
        ...
        $this->forge->createTable('goodreads');
    }

    public function down()
    {
        $this->forge->dropTable('goodreads');
    }
}
