...
<?= $this->section('content') ?>
    <div class="content h-entry h-review">
        ...
        <header class="title">
            ...
            <div class="source tumblr">
                ...
                <a class="u-syndication" href="<?= $data->link ?>" target="_blank">This review was first published on <strong>This Reviewer's Life</strong>. Visit the original here →</a>
            </div>
        </header>
        <article>
            <div class="hexagon content__date">
                <time class="hexagon__inner dt-published dt-reviewed" datetime="<?= date('c', strtotime($data->pubDate)) ?>">
                    <span class="month"><?= date('M', strtotime($data->pubDate)) ?></span>
                    <span class="day"><?= date('d', strtotime($data->pubDate)) ?></span>
                </time>
            </div>
            <div class="content__body e-content e-description">
                <?= $data->content ?>
            </div>
        </article>
